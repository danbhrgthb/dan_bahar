...
In other words, normally, the code is “single-threaded,” meaning that one thread uses one core, and the other cores sit there doing nothing. However, following this protocol will get the other idle threads to help run commands. This is very important for complex profiling tools like bowtie2.... or else some runs may take forever to generate an output.
